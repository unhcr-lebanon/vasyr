...
write.csv(household, "data/encoded/household.csv")
write.csv(case_number_details, "data/encoded/case_number_details.csv")
write.csv(individual_biodata , "data/encoded/individual_biodata.csv")
write.csv(difficulties_encountered, "data/encoded/difficulties_encountered.csv")
write.csv(illegal_residence, "data/encoded/illegal_residence.csv")
write.csv(legal_residence , "data/encoded/legal_residence.csv")
write.csv(moved_returnee, "data/encoded/moved_returnee.csv")
